...
import OnRadioGroupBase from "../base/radio_group/radio_group.vue";
...
@Component<OnRadioGroup>({
  name: "OnRadioGroup",
  components: {
    OnRadioGroupBase: OnRadioGroupBase,
  },
})
export default class OnRadioGroup extends mixins(InputValueMixin) {
  @Prop({
    default: () => []
  })
